...
public class Ejercicio08 {
	...
	public static void main(String[] args) {
		...
		//Hasta que dado1 no almacene uno de los valores que queremos seguira dentro del bucle
		} while (dado1 < 0);
		...
		//Hasta que dado2 no almacene uno de los valores que queremos seguira dentro del bucle
		} while(dado2 < 0);
